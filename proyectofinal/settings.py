...
SECRET_KEY = 'django-insecure-x)o$q9$c!&p$m=9t+7xq*92x4b!2ohg#s09pl#%zdj3@z#4*g^'
...
TEMPLATES = [
    {
        ...
        'DIRS': ["C:/Proyecto Final Python/proyectofinal/plantillas/"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
